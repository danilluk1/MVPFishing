...
namespace Fishing.BL.Model.Fishes
{
    ...
    public class Chub : Fish
    {
        ...
        public Chub(int minD, int maxD, double maxSizeCoef, HashSet<Lure> lu) : base(name, randWigth.Next(200, Convert.ToInt32(4000 * maxSizeCoef)), Power.SetPower(3, 2), price, trophyWeight, lures, activParts, description, bit)
        {
            MinDeep = minD;
            MaxDeep = maxD;
