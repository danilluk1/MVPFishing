...
namespace Fishing
{
    ...
    public class PinkSalmon : Fish
    {
        ...
        public PinkSalmon(int minD, int maxD, double maxSizeCoef, HashSet<Lure> lu) : base(name, randWigth.Next(500, 20000), power, price, trophyWeight, lures, activParts, description, bit)
        {
            MinDeep = minD;
            MaxDeep = maxD;
